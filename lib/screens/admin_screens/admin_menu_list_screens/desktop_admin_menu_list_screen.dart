...
class DesktopAdminMenuListScreen extends StatefulWidget {
  final Map<String, dynamic> bookingData;
  const DesktopAdminMenuListScreen({super.key, required this.bookingData});

  @override
  State<DesktopAdminMenuListScreen> createState() =>
      _DesktopAdminMenuListScreenState();
}

class _DesktopAdminMenuListScreenState
    extends State<DesktopAdminMenuListScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: DesktopAppBar(title: 'cart_title'.tr(), isClickable: false),
      body: Center(
        child: SizedBox(

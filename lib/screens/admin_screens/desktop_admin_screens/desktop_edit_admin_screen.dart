...
class DesktopEditAdminScreen extends StatefulWidget {
  const DesktopEditAdminScreen({super.key});

  @override
  State<DesktopEditAdminScreen> createState() => _DesktopEditAdminScreenState();
}

class _DesktopEditAdminScreenState extends State<DesktopEditAdminScreen> {
  @override
                          ...
                          child: InkWell(
                            onTap: () {
                              Navigator.push(context,
                                ...
                                return const DesktopSignUpScreen();
                              }));
                            },
                            child: Text(
                              'signup'.tr(),

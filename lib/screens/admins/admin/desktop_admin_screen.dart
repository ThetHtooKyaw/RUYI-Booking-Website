      ...
      switch (index) {
        case 0:
          ...
          Provider.of<AdminAuthProvider>(context, listen: false)
              .loadAdminData();
          _currentBody = const DesktopEditAdminDetailScreen();
          break;
        case 1:
          _title = 'manage_booking_title'.tr();
          bookingService.refershBookingList();
          _currentBody = const DesktopEditBookingListScreen();
          break;
        case 2:
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          const LanguagePicker(offset: 45, color: AppColors.appAccent),

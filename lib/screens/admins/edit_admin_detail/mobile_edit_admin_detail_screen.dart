...
class MobileEditAdminDetailScreen extends StatefulWidget {
  const MobileEditAdminDetailScreen({super.key});

  @override
  State<MobileEditAdminDetailScreen> createState() =>
      _MobileEditAdminDetailScreenState();
}

class _MobileEditAdminDetailScreenState
    extends State<MobileEditAdminDetailScreen> {
  @override
